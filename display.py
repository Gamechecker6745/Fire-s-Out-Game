...
class Display:
    def __init__(self, app) -> None:
        ...
        self.scenes = {"menu": [Default(self.app, (400, 80), align=1, surface=render_text("Fire's Out", 80, (255, 255, 255))),
                                ...
                                Default(self.app, (600, 400), dimensions=(200, 75), surface=exit_button, align=1, action=self.app.exit_game, show_hover=True)],
                       ...
                       "levels":[Default(self.app, (50 + 400*(idx%2), 50 + 50 * (idx - idx%2)), surface=render_text(f"L{idx + 1}", 50, (255, 255, 255)), show_hover=True, action=select_level, args=(self.app,level)) for idx, level in enumerate(self.app.levels)] + 
                                [Default(self.app, (WIDTH - 5, menu_button.get_height() + 5), surface=menu_button, align=2, action=switch_scene, args=(self.app, "menu"), show_hover=True, hover_colour=(255, 255, 0))],
                       "game": [self.app.game,
                                Default(self.app, (600, 50), dimensions=(50, 50), surface=render_text("||", 500, (255, 255, 255)), action=self.app.game.toggle_pause, show_hover=True, align=1),
                                Default(self.app, (650, 50), dimensions=(50, 50), surface=render_text(">>", 500, (255, 255, 255)), action=self.app.game.speed_change, args=(2,), show_hover=True, align=1),
                                Default(self.app, (550, 50), dimensions=(50, 50), surface=render_text("<<", 500, (255, 255, 255)), action=self.app.game.speed_change, args=(1/2,), show_hover=True, align=1),
                                Default(self.app, (600, 150), surface=render_text("next tick", 20, (255, 255, 255)), action=self.app.game.tick, show_hover=True, align=1),
                                Default(self.app, (20, 50), surface=render_text(f"Budget: {str(self.app.game.level.budget)}", 30, (255, 255, 255))),
                                Default(self.app, (20, 100), surface=render_text(f"Population: {str(self.app.game.population)}", 30, (255, 255, 255))),
                                Default(self.app, (20, 150), surface=render_text(f"Total fire: {str(round(self.app.game.total_fire, 2))}", 30, (255, 255, 255))),
                                Default(self.app, (WIDTH - 5, menu_button.get_height() + 5), surface=menu_button, align=2, action=switch_scene, args=(self.app, "menu"), show_hover=True, hover_colour=(255, 255, 0)),],
                        "game_over": [Default(self.app, (WIDTH - 5, menu_button.get_height() + 5), surface=menu_button, align=2, action=switch_scene, args=(self.app, "menu"), show_hover=True, hover_colour=(255, 255, 0)),
                                      Default(self.app, (20, 150), surface=render_text(f"Budget: {str(self.app.game.level.budget)}", 30, (255, 255, 255))),
                                      Default(self.app, (20, 200), surface=render_text(f"Population: {str(self.app.game.population)}", 30, (255, 255, 255))),
                                      Default(self.app, (20, 250), surface=render_text(f"Fire: {str(round(self.app.game.total_fire, 1))}", 30, (255, 255, 255)))]}
        self.scene = "menu"
    ...
    def update(self):
        ...
        match self.scene:
                case "game":
                    self.scenes[self.scene][5].update_surface(render_text(f"Budget: {str(self.app.game.level.budget)}", 30, (255, 255, 255)), update_dimensions=True)
                    self.scenes[self.scene][6].update_surface(render_text(f"Population: {str(self.app.game.population)}", 30, (255, 255, 255)), update_dimensions=True)
                    self.scenes[self.scene][7].update_surface(render_text(f"Total fire: {str(round(self.app.game.total_fire, 2))}", 30, (255, 255, 255)), update_dimensions=True)
                case "game_over":
                    self.scenes[self.scene][1].update_surface(render_text(f"Budget: {str(self.app.game.level.budget)}", 30, (255, 255, 255)))
                    self.scenes[self.scene][2].update_surface(render_text(f"Population: {str(self.app.game.population)}", 30, (255, 255, 255)))
                    self.scenes[self.scene][3].update_surface(render_text(f"Fire: {str(round(self.app.game.total_fire, 1))}", 30, (255, 255, 255)), update_dimensions=True)
